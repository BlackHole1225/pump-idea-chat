...
const MessageShowModal: React.FC<MessageShowModalProps> = ({
  ...
  return (
    <Dialog open={isOpen} onClose={onRequestClose}>
      <Stack
        color={theme.bgColor}
        sx={{ background: theme.text_color }}
        direction="column"
        justifyItems="center"
        spacing={2}
        className="rounded-lg overflow-hidden uppercase w-[480px] max-w-full h-[428px] max-h-full p-4"
      >
        ...
        >
          <Button
            ...
            style={{ color: theme.text_color, width: "100%" }}
          >
            back to chat
          </Button>
        </Box>
